...
namespace oyinQ.Bot.Data.Migrations
{
    ...
    [Migration("20260924101113_CampVisibilityDefaults")]
    partial class CampVisibilityDefaults
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampBggImport", b =>
                {
                    ...
                    b.Property<int>("FoundExpansions")
                        .HasColumnType("integer");

                    b.Property<int>("FoundGames")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampBringRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CampId", "OwnerParticipantId", "BggId")
                        .IsUnique();

                    b.ToTable("CampBringRequests", t =>
                        {
                            t.HasCheckConstraint("CK_CampBringRequest_BggId", "\"BggId\" > 0");
                        });
                });

            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampBringRequester", b =>
                {
                    ...
                    b.PrimitiveCollection<DateOnly[]>("Dates")
                        .IsRequired()
                        .HasColumnType("date[]");

                    b.HasKey("RequestId", "ParticipantId");

                    b.HasIndex("ParticipantId", "CreatedAt");

                    b.ToTable("CampBringRequesters");
                });
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampGameContribution", b =>
                {
                    ...
                    b.PrimitiveCollection<DateOnly[]>("AvailableDates")
                        .HasColumnType("date[]");
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampParticipantVisibility", b =>
                {
                    b.Property<long>("CampId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("ShareCollection")
                        .HasColumnType("boolean");

                    b.Property<bool>("ShareWishes")
                        .HasColumnType("boolean");

                    b.HasKey("CampId", "ParticipantId");

                    b.HasIndex("ParticipantId");

                    b.ToTable("CampParticipantVisibilities", (string)null);
                });
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.GameGathering", b =>
                {
                    ...
                    b.Property<Guid?>("PublicationAttemptId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("PublicationLeaseExpiresAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("CommunityKey", "OrganizerParticipantId", "CreationOperationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.Notification", b =>
                {
                    ...
                    b.Property<long?>("ActorParticipantId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.RecruitmentDigest", b =>
                {
                    ...
                    b.Property<bool>("IncludeAllUpcoming")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampBringRequest", b =>
                {
                    ...
                    b.HasOne("oyinQ.Bot.Data.Entities.Participant", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampBringRequester", b =>
                {
                    ...
                    b.HasOne("oyinQ.Bot.Data.Entities.CampBringRequest", "Request")
                        .WithMany("Requesters")
            ...
            modelBuilder.Entity("oyinQ.Bot.Data.Entities.CampParticipantVisibility", b =>
                {
                    b.HasOne("oyinQ.Bot.Data.Entities.Camp", null)
                        .WithMany()
                        .HasForeignKey("CampId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
