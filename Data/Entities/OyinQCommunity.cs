...
public sealed class OyinQCommunity
{
    ...
    public int RecruitmentCooldownHours { get; set; } = 4;
    public DateTimeOffset? LastRecruitmentDigestAt { get; set; }
    ...
    public BotCommunity ToBotCommunity() =>
        new(Key, Name, TelegramChatId, Mode, TimeZoneId, Camp?.StartDate, Camp?.EndDate, Camp?.StartsAtUtc, Camp?.EndsAtUtc);
}
