/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.worker-types.env --strict-vars=false` (hash: f4e4a4d904e3c0a995bd3e73dd01ce99)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	TESERA_PROXY_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TESERA_PROXY_SECRET">> {}
}
