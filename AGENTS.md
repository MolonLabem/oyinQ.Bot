...
BGG name search is explicitly user-triggered, returns at most 25 ranked results, and enriches only that bounded result set through batched `/thing?versions=1` requests. Do not add background search polling or recurring catalog synchronization.
