...
15. Cancel Camp registration; verify contributions/import work/future participation are removed, while history and other communities remain.
16. Start a large BGG import, close/reopen the Mini App, and verify the persisted job continues.
17. In import selection, test expansion-without-base warning and explicitly add a personal copy of a base-library duplicate.
18. Try to add a base-library duplicate manually; verify both UI and backend reject it.
