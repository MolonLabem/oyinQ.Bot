...
Проверить пункты 9–14 в [планировании и партиях](planning-notifications-plays.md): отрицательный исход без партии, фактический состав и несколько ссылок BG Stats, внешнюю игру с дополнениями и явным владением, атомарность локальных изменений, предпросмотр рассылки и повтор только ошибочных получателей. Текущий текст выпуска для Telegram хранится отдельным встроенным ресурсом в [объявлении от 7 сентября](releases/2026-09-07.md).
