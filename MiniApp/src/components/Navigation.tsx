export type NavigationIconName = "gatherings" | "games" | "profile" | "communities" | "export" | "updates";
...
function NavigationIcon({ name }: { name: NavigationIconName }) {
  if (name === "export") return <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 3v12m-4-4 4 4 4-4M5 16v4h14v-4" /></svg>;
  if (name === "updates") return <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="m4 10 15-6v14L4 13Zm3 4 2 6h4l-2-5M19 9h2v4h-2" /></svg>;
